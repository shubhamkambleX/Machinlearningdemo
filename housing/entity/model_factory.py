...
MetricInfoArtifact = namedtuple("MetricInfoArtifact",
                                ["model_name", "model_object", "train_log_loss", "test_log_loss", "train_accuracy",
...
def evaluate_regression_model(model_list: list, X_train:np.ndarray, y_train:np.ndarray, X_test:np.ndarray, y_test:np.ndarray, base_accuracy:float=0.6) -> MetricInfoArtifact:
    ...
    try:
        ...
        for model in model_list:
            ...
            #Calculating log loss on training and testing dataset
            ...
            logging.info(f"Train log loss error: [{train_log_loss}].")
            logging.info(f"Test log loss error: [{test_log_loss}].")
